...
import { mockPosts } from './mockData'; // Import the mock data
      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            Discover insightful articles and updates on our latest blog posts. Stay informed and engaged with our content.
          </p>
          <div className="flex gap-3">
            <Link href="/get-started" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
          <img src="/blogs1.png" alt="Blog overview mockup" className="object-cover" />
        </div>
      </div>
    </section>
