                    ...
                    {posts.map((post, index) => (
                        <li className="w-full mx-auto group sm:max-w-sm" key={index}>
                            <a href={post.href} className="block">
                                <img src={post.img} loading="lazy" alt={post.title} className="w-full rounded-lg" />
                                <div className="mt-3 space-y-2">
                                    <span className="block text-indigo-600 text-sm">{post.date}</span>
                                    <h3 className="text-lg text-gray-800 duration-150 group-hover:text-gray-300 font-semibold">
                                        {post.title}
                                    </h3>
                                    <p className="text-gray-400 text-sm duration-150 group-hover:text-gray-600">{post.desc}</p>
                                </div>
                            </a>
                        </li>
                    ))}
